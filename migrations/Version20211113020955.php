 ...
 */
final class Version20211113020955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classified_ad (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, region_id INT NOT NULL, user_id INT NOT NULL, garage_id INT NOT NULL, brand_id INT NOT NULL, reference VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price INT NOT NULL, year VARCHAR(255) NOT NULL, kilometre INT NOT NULL, fuel VARCHAR(255) NOT NULL, type_of_vehicle VARCHAR(255) NOT NULL, gearbox VARCHAR(255) NOT NULL, car_doors VARCHAR(255) NOT NULL, places VARCHAR(255) NOT NULL, photos JSON NOT NULL, model_complement VARCHAR(255) DEFAULT NULL, model_complement2 VARCHAR(255) DEFAULT NULL, power VARCHAR(255) NOT NULL, prime_eco TINYINT(1) DEFAULT NULL, top_ocass TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, updated_on_at DATETIME NOT NULL, INDEX IDX_6869CB767975B7E7 (model_id), INDEX IDX_6869CB7698260155 (region_id), INDEX IDX_6869CB76A76ED395 (user_id), INDEX IDX_6869CB76C4FFF555 (garage_id), INDEX IDX_6869CB7644F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE garage (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, image_garage JSON NOT NULL, street_number INT NOT NULL, street_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, postal_code INT NOT NULL, city VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_on_at DATETIME NOT NULL, INDEX IDX_9F26610BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE search (id INT AUTO_INCREMENT NOT NULL, car_doors LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', fuel LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', gearbox LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', models LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', places LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', regions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', type_of_vehicle LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', kilometrage LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', min_kilometre INT DEFAULT NULL, max_kilometre INT DEFAULT NULL, powers LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', min_power INT DEFAULT NULL, max_power INT DEFAULT NULL, years LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', min_year INT DEFAULT NULL, max_year INT DEFAULT NULL, prices LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', min_price INT DEFAULT NULL, max_price INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, society VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, siret VARCHAR(255) NOT NULL, date_of_registration DATETIME NOT NULL, roles JSON NOT NULL, updated_on DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
